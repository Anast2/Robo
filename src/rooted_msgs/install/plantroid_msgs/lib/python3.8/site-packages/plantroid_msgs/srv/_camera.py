...
class Camera_Request(metaclass=Metaclass_Camera_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.imagetype = kwargs.get('imagetype', int())
    ...
    def imagetype(self, value):
        if __debug__:
            assert \
                ...
                "The 'imagetype' field must be of type 'int'"
            assert value >= -128 and value < 128, \
                "The 'imagetype' field must be an integer in [-128, 127]"
        self._imagetype = value
...
class Metaclass_Camera(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from plantroid_msgs.srv import _camera
...
class Camera(metaclass=Metaclass_Camera):
    from plantroid_msgs.srv._camera import Camera_Request as Request
    from plantroid_msgs.srv._camera import Camera_Response as Response
