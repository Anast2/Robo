...
class Metaclass_Command_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from plantroid_msgs.msg import Speed
...
class Command_Request(metaclass=Metaclass_Command_Request):
    ...
    _fields_and_field_types = {
        'speed_command': 'plantroid_msgs/Speed',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['plantroid_msgs', 'msg'], 'Speed'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from plantroid_msgs.msg import Speed
        self.speed_command = kwargs.get('speed_command', Speed())
    ...
    def speed_command(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'speed_command' field must be a sub message of type 'Speed'"
...
class Metaclass_Command(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from plantroid_msgs.srv import _command
...
class Command(metaclass=Metaclass_Command):
    from plantroid_msgs.srv._command import Command_Request as Request
    from plantroid_msgs.srv._command import Command_Response as Response
