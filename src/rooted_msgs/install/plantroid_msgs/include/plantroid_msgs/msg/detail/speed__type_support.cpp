...
{
  new (message_memory) plantroid_msgs::msg::Speed(_init);
}

void Speed_fini_function(void * message_memory)
{
  auto typed_message = static_cast<plantroid_msgs::msg::Speed *>(message_memory);
  typed_message->~Speed();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Speed_message_member_array[2] = {
  {
    ...
    offsetof(plantroid_msgs::msg::Speed, linear),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(plantroid_msgs::msg::Speed, angular),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Speed_message_members = {
  ...
  "Speed",  // message name
  2,  // number of fields
  sizeof(plantroid_msgs::msg::Speed),
...
get_message_type_support_handle<plantroid_msgs::msg::Speed>()
{
  return &::plantroid_msgs::msg::rosidl_typesupport_introspection_cpp::Speed_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, plantroid_msgs, msg, Speed)() {
  return &::plantroid_msgs::msg::rosidl_typesupport_introspection_cpp::Speed_message_type_support_handle;
}
