...
static const _Camera_Request_type_support_symbol_names_t _Camera_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plantroid_msgs, srv, Camera_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, plantroid_msgs, srv, Camera_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, plantroid_msgs, srv, Camera_Request)() {
  return &::plantroid_msgs::srv::rosidl_typesupport_c::Camera_Request_message_type_support_handle;
}
...
static const _Camera_Response_type_support_symbol_names_t _Camera_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plantroid_msgs, srv, Camera_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, plantroid_msgs, srv, Camera_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_plantroid_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, plantroid_msgs, srv, Camera_Response)() {
  return &::plantroid_msgs::srv::rosidl_typesupport_c::Camera_Response_message_type_support_handle;
}
...
static const _Camera_type_support_symbol_names_t _Camera_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plantroid_msgs, srv, Camera)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, plantroid_msgs, srv, Camera)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, plantroid_msgs, srv, Camera)() {
  return &::plantroid_msgs::srv::rosidl_typesupport_c::Camera_service_type_support_handle;
}
