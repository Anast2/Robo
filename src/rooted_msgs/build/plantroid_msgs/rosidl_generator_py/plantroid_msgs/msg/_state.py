...
class Metaclass_State(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from plantroid_msgs.msg import Pose
...
class State(metaclass=Metaclass_State):
    ...
    _fields_and_field_types = {
        'pose': 'plantroid_msgs/Pose',
        'speed': 'plantroid_msgs/Speed',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['plantroid_msgs', 'msg'], 'Pose'),  # noqa: E501
