...
bool plantroid_msgs__msg__pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("plantroid_msgs.msg._pose.Pose", full_classname_dest, 29) == 0);
  }
  plantroid_msgs__msg__Pose * ros_message = _ros_message;
  {  // x
...
PyObject * plantroid_msgs__msg__pose__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("plantroid_msgs.msg._pose");
