...
#include "plantroid_msgs/srv/detail/command__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const plantroid_msgs::msg::Speed &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  plantroid_msgs::msg::Speed &);
...
cdr_serialize(
  const plantroid_msgs::srv::Command_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: speed_command
  plantroid_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  plantroid_msgs::srv::Command_Request & ros_message)
{
  // Member: speed_command
  plantroid_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    plantroid_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: speed_command
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        plantroid_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Speed(
...
{
  auto typed_message =
    static_cast<const plantroid_msgs::srv::Command_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<plantroid_msgs::srv::Command_Request *>(
    untyped_ros_message);
...
{
  return &plantroid_msgs::srv::typesupport_fastrtps_cpp::_Command_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, plantroid_msgs, srv, Command_Request)() {
  return &plantroid_msgs::srv::typesupport_fastrtps_cpp::_Command_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_plantroid_msgs
cdr_serialize(
  const plantroid_msgs::srv::Command_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  plantroid_msgs::srv::Command_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
...
{
  auto typed_message =
    static_cast<const plantroid_msgs::srv::Command_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<plantroid_msgs::srv::Command_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &plantroid_msgs::srv::typesupport_fastrtps_cpp::_Command_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, plantroid_msgs, srv, Command_Response)() {
  return &plantroid_msgs::srv::typesupport_fastrtps_cpp::_Command_Response__handle;
}
...
{
  return &plantroid_msgs::srv::typesupport_fastrtps_cpp::_Command__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, plantroid_msgs, srv, Command)() {
  return &plantroid_msgs::srv::typesupport_fastrtps_cpp::_Command__handle;
}
