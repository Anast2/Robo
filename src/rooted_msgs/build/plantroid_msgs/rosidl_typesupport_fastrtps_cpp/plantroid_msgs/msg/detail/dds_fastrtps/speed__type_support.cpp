...
#include "plantroid_msgs/msg/detail/speed__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const plantroid_msgs::msg::Speed *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<plantroid_msgs::msg::Speed *>(
    untyped_ros_message);
...
{
  return &plantroid_msgs::msg::typesupport_fastrtps_cpp::_Speed__handle;
}
