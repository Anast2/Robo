...
#include "plantroid_msgs/msg/detail/state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const plantroid_msgs::msg::Pose &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  plantroid_msgs::msg::Pose &);
  ...
  size_t current_alignment)
{
  ...
  // Member: pose
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        plantroid_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Pose(
...
{
  auto typed_message =
    static_cast<const plantroid_msgs::msg::State *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<plantroid_msgs::msg::State *>(
    untyped_ros_message);
...
{
  return &plantroid_msgs::msg::typesupport_fastrtps_cpp::_State__handle;
}
