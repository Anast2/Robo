...
static const _Camera_Request_type_support_symbol_names_t _Camera_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, plantroid_msgs, srv, Camera_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, plantroid_msgs, srv, Camera_Request)),
  }
};
...
{
  return &::plantroid_msgs::srv::rosidl_typesupport_cpp::Camera_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, plantroid_msgs, srv, Camera_Request)() {
  return get_message_type_support_handle<plantroid_msgs::srv::Camera_Request>();
}
...
static const _Camera_Response_type_support_symbol_names_t _Camera_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, plantroid_msgs, srv, Camera_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, plantroid_msgs, srv, Camera_Response)),
  }
};
...
{
  return &::plantroid_msgs::srv::rosidl_typesupport_cpp::Camera_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, plantroid_msgs, srv, Camera_Response)() {
  return get_message_type_support_handle<plantroid_msgs::srv::Camera_Response>();
}
...
static const _Camera_type_support_symbol_names_t _Camera_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, plantroid_msgs, srv, Camera)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, plantroid_msgs, srv, Camera)),
  }
};
...
{
  return &::plantroid_msgs::srv::rosidl_typesupport_cpp::Camera_service_type_support_handle;
}
