...
#include "plantroid_msgs/srv/detail/command__rosidl_typesupport_fastrtps_c.h"
...
#include "plantroid_msgs/msg/detail/speed__functions.h"  // speed_command

// forward declare type support functions
size_t get_serialized_size_plantroid_msgs__msg__Speed(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_plantroid_msgs__msg__Speed(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plantroid_msgs, msg, Speed)();


using _Command_Request__ros_msg_type = plantroid_msgs__srv__Command_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: speed_command
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, plantroid_msgs, msg, Speed
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->speed_command, cdr))
    {
      return false;
    }
  }
...
size_t get_serialized_size_plantroid_msgs__srv__Command_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Command_Request__ros_msg_type * ros_message = static_cast<const _Command_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_plantroid_msgs__msg__Speed(
...
static uint32_t _Command_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_plantroid_msgs__srv__Command_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_plantroid_msgs
size_t max_serialized_size_plantroid_msgs__srv__Command_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: speed_command
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_plantroid_msgs__msg__Speed(
...
{
  return max_serialized_size_plantroid_msgs__srv__Command_Request(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plantroid_msgs, srv, Command_Request)() {
...
using _Command_Response__ros_msg_type = plantroid_msgs__srv__Command_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_plantroid_msgs
size_t get_serialized_size_plantroid_msgs__srv__Command_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Command_Response__ros_msg_type * ros_message = static_cast<const _Command_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_plantroid_msgs__srv__Command_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_plantroid_msgs
size_t max_serialized_size_plantroid_msgs__srv__Command_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_plantroid_msgs__srv__Command_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plantroid_msgs, srv, Command_Response)() {
...
// already included above
// #include "plantroid_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "plantroid_msgs/srv/command.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, plantroid_msgs, srv, Command)() {
