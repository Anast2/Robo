...
def generate_launch_description():
    ...
    param_override_pkg2 = {"mode": "local", "IP": "127.0.0.1", "PORT": "5050"}
    param_override_pkg3 = {"DEVICENAME": "/dev/ttyServo", "BAUDRATE": "1_000_000"}
    param_override_pkg4 = {"raspi": "False"}
    ...
    param_override_pkg7 = {
        "audio_folder_path": f"{home_dir}/rooted/src/robot_memory/db/audio"
    }
    param_override_pkg8 = {
        "image_folder": f"{home_dir}/rooted/src/facial_expression/facial_expression/IMG/"
    }
    param_override_pkg9 = {
        "mode": "local",
        "model": "espeak-ng",
    ...
    param_override_pkg12 = {
        "plant_info_file": f"{home_dir}/rooted/src/plant_model/plant_characteristics.json",
        "db_path": f"{home_dir}/rooted/src/robot_memory/db/plant.db",
    }
    param_override_pkg13 = {
        "db_folder_path": f"{home_dir}/rooted/src/robot_memory/db/people.db",
        "use_pc_camera": "True",
        "camera_number": "0",
        "camera_topic": "/camera/image_raw",
    }
    param_override_pkg14 = {
        "dialog_json": f"{home_dir}/rooted/src/maestro/maestro/dialogue.json",
        "store_chat_log": "False",
        "keep_eye_contact": "False",
        "pc_mode": "True",
        "store_emotion_change": "False",
    ...
    pkg1_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            FindPackageShare("rooted_busy"),
            "/launch/busy_launch.py",
        ])
    )

    pkg2_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            FindPackageShare("rooted_llm"),
            "/launch/llm_service_launch.py",
        ]),
        launch_arguments={
            "mode": param_override_pkg2.get("mode"),
            "IP": param_override_pkg2.get("IP"),
            "PORT": param_override_pkg2.get("PORT"),
        }.items(),
    )
    ...
    pkg7_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            FindPackageShare("listening_module"),
            "/launch/listener_launch.py",
        ]),
        launch_arguments={
            "audio_folder_path": param_override_pkg7.get("audio_folder_path")
        }.items(),
    )

    pkg8_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            FindPackageShare("facial_expression"),
            "/launch/facial_expression_launch.py",
        ]),
        launch_arguments={
            "image_folder": param_override_pkg8.get("image_folder")
        }.items(),
    )

    pkg9_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            FindPackageShare("rooted_speech_synthesizer"),
            "/launch/tts_service_launch.py",
        ]),
        launch_arguments={
            "mode": param_override_pkg9.get("mode"),
            "model": param_override_pkg9.get("model"),
            "IP": param_override_pkg9.get("IP"),
            "PORT": param_override_pkg9.get("PORT"),
        }.items(),
    )

    pkg10_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            FindPackageShare("robot_memory"),
            "/launch/robot_memory_launch.py",
        ]),
        launch_arguments={
            "db_folder_path": param_override_pkg10.get("db_folder_path")
        }.items(),
    )

    pkg11_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            FindPackageShare("other_sensors"),
            "/launch/fake_sensors_launch.py",
        ])
    )
    ...
    pkg13_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            ...
            "/launch/fake_vision_module_launch.py",
        ]),
        launch_arguments={
            "db_folder_path": param_override_pkg13.get("db_folder_path"),
            "use_pc_camera": param_override_pkg13.get("use_pc_camera"),
            "camera_number": param_override_pkg13.get("camera_number"),
            "camera_topic": param_override_pkg13.get("camera_topic"),
        }.items(),
    )

    pkg14_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            FindPackageShare("maestro"),
            "/launch/maestro_launch.py",
        ]),
        launch_arguments={
            "dialog_json": param_override_pkg14.get("dialog_json"),
            ...
            "robot_name": param_override_pkg14.get("robot_name"),
        }.items(),
    )
